...
var TUploadDataReq = module.exports.TUploadDataReq = function(args) {
  this.sessionHandle = null;
  this.tableName = null;
  this.path = null;
  this.values = null;
...
TUploadDataReq.prototype = {};
TUploadDataReq.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TUploadDataReq.prototype.write = function(output) {
  output.writeStructBegin('TUploadDataReq');
  if (this.sessionHandle !== null && this.sessionHandle !== undefined) {
    output.writeFieldBegin('sessionHandle', Thrift.Type.STRUCT, 1);
    this.sessionHandle.write(output);
    output.writeFieldEnd();
...
var TUploadDataResp = module.exports.TUploadDataResp = function(args) {
  this.status = null;
  this.operationHandle = null;
  if (args) {
    if (args.status !== undefined && args.status !== null) {
...
TUploadDataResp.prototype = {};
TUploadDataResp.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TUploadDataResp.prototype.write = function(output) {
  output.writeStructBegin('TUploadDataResp');
  if (this.status !== null && this.status !== undefined) {
    output.writeFieldBegin('status', Thrift.Type.STRUCT, 1);
    this.status.write(output);
    output.writeFieldEnd();
...
var TDownloadDataReq = module.exports.TDownloadDataReq = function(args) {
  this.sessionHandle = null;
  this.tableName = null;
  this.query = null;
  this.format = null;
  ...
  if (args) {
    ...
    if (args.downloadOptions !== undefined && args.downloadOptions !== null) {
      this.downloadOptions = Thrift.copyMap(args.downloadOptions, [null]);
    }
  }
};
TDownloadDataReq.prototype = {};
TDownloadDataReq.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i121 = 0; _i121 < _size119; ++_i121) {
          ...
          val123 = input.readString();
          this.downloadOptions[key122] = val123;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TDownloadDataReq.prototype.write = function(output) {
  output.writeStructBegin('TDownloadDataReq');
  if (this.sessionHandle !== null && this.sessionHandle !== undefined) {
    output.writeFieldBegin('sessionHandle', Thrift.Type.STRUCT, 1);
    this.sessionHandle.write(output);
    output.writeFieldEnd();
  ...
  if (this.format !== null && this.format !== undefined) {
    output.writeFieldBegin('format', Thrift.Type.STRING, 4);
    output.writeString(this.format);
    output.writeFieldEnd();
  }
  if (this.downloadOptions !== null && this.downloadOptions !== undefined) {
    output.writeFieldBegin('downloadOptions', Thrift.Type.MAP, 5);
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.downloadOptions));
    for (var kiter124 in this.downloadOptions) {
      if (this.downloadOptions.hasOwnProperty(kiter124)) {
        var viter125 = this.downloadOptions[kiter124];
...
var TDownloadDataResp = module.exports.TDownloadDataResp = function(args) {
  this.status = null;
  this.operationHandle = null;
  if (args) {
    if (args.status !== undefined && args.status !== null) {
...
TDownloadDataResp.prototype = {};
TDownloadDataResp.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TDownloadDataResp.prototype.write = function(output) {
  output.writeStructBegin('TDownloadDataResp');
  if (this.status !== null && this.status !== undefined) {
    output.writeFieldBegin('status', Thrift.Type.STRUCT, 1);
    this.status.write(output);
    output.writeFieldEnd();
...
TGetTablesReq.prototype.write = function(output) {
  ...
  if (this.tableTypes !== null && this.tableTypes !== undefined) {
    ...
    for (var iter130 in this.tableTypes) {
      if (this.tableTypes.hasOwnProperty(iter130)) {
        iter130 = this.tableTypes[iter130];
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i137 = 0; _i137 < _size135; ++_i137) {
          ...
          for (var _i141 = 0; _i141 < _size139; ++_i141) {
            ...
            elem138.push(elem142);
          }
          input.readListEnd();
          this.rows.push(elem138);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TProgressUpdateResp.prototype.write = function(output) {
  ...
  if (this.headerNames !== null && this.headerNames !== undefined) {
    ...
    for (var iter143 in this.headerNames) {
      if (this.headerNames.hasOwnProperty(iter143)) {
        iter143 = this.headerNames[iter143];
  ...
  if (this.rows !== null && this.rows !== undefined) {
    ...
    for (var iter144 in this.rows) {
      if (this.rows.hasOwnProperty(iter144)) {
        iter144 = this.rows[iter144];
        output.writeListBegin(Thrift.Type.STRING, iter144.length);
        for (var iter145 in iter144) {
          if (iter144.hasOwnProperty(iter145)) {
            iter145 = iter144[iter145];
