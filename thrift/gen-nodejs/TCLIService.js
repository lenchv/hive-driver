...
var TCLIService_UploadData_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new ttypes.TUploadDataReq(args.req);
    }
  }
};
TCLIService_UploadData_args.prototype = {};
TCLIService_UploadData_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.req = new ttypes.TUploadDataReq();
        this.req.read(input);
      } else {
        input.skip(ftype);
      }
...
TCLIService_UploadData_args.prototype.write = function(output) {
  output.writeStructBegin('TCLIService_UploadData_args');
  if (this.req !== null && this.req !== undefined) {
    output.writeFieldBegin('req', Thrift.Type.STRUCT, 1);
    this.req.write(output);
    output.writeFieldEnd();
...
var TCLIService_UploadData_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.TUploadDataResp(args.success);
    }
  }
};
TCLIService_UploadData_result.prototype = {};
TCLIService_UploadData_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new ttypes.TUploadDataResp();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
TCLIService_UploadData_result.prototype.write = function(output) {
  output.writeStructBegin('TCLIService_UploadData_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
var TCLIService_DownloadData_args = function(args) {
  this.req = null;
  if (args) {
    if (args.req !== undefined && args.req !== null) {
      this.req = new ttypes.TDownloadDataReq(args.req);
    }
  }
};
TCLIService_DownloadData_args.prototype = {};
TCLIService_DownloadData_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRUCT) {
        this.req = new ttypes.TDownloadDataReq();
        this.req.read(input);
      } else {
        input.skip(ftype);
      }
...
TCLIService_DownloadData_args.prototype.write = function(output) {
  output.writeStructBegin('TCLIService_DownloadData_args');
  if (this.req !== null && this.req !== undefined) {
    output.writeFieldBegin('req', Thrift.Type.STRUCT, 1);
    this.req.write(output);
    output.writeFieldEnd();
...
var TCLIService_DownloadData_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new ttypes.TDownloadDataResp(args.success);
    }
  }
};
TCLIService_DownloadData_result.prototype = {};
TCLIService_DownloadData_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new ttypes.TDownloadDataResp();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
TCLIService_DownloadData_result.prototype.write = function(output) {
  output.writeStructBegin('TCLIService_DownloadData_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
TCLIServiceClient.prototype.UploadData = function(req, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
TCLIServiceClient.prototype.send_UploadData = function(req) {
  var output = new this.pClass(this.output);
  var params = {
    req: req
  };
  var args = new TCLIService_UploadData_args(params);
  try {
    output.writeMessageBegin('UploadData', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
TCLIServiceClient.prototype.recv_UploadData = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new TCLIService_UploadData_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('UploadData failed: unknown result');
};

TCLIServiceClient.prototype.DownloadData = function(req, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
TCLIServiceClient.prototype.send_DownloadData = function(req) {
  var output = new this.pClass(this.output);
  var params = {
    req: req
  };
  var args = new TCLIService_DownloadData_args(params);
  try {
    output.writeMessageBegin('DownloadData', Thrift.MessageType.CALL, this.seqid());
    args.write(output);
    output.writeMessageEnd();
    return this.output.flush();
  }
...
TCLIServiceClient.prototype.recv_DownloadData = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new TCLIService_DownloadData_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('DownloadData failed: unknown result');
};
...
TCLIServiceProcessor.prototype.process_UploadData = function(seqid, input, output) {
  var args = new TCLIService_UploadData_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.UploadData.length === 1) {
    Q.fcall(this._handler.UploadData.bind(this._handler),
      args.req
    ).then(function(result) {
      var result_obj = new TCLIService_UploadData_result({success: result});
      output.writeMessageBegin("UploadData", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
      output.writeMessageBegin("UploadData", Thrift.MessageType.EXCEPTION, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    });
  } else {
    this._handler.UploadData(args.req, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new TCLIService_UploadData_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("UploadData", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("UploadData", Thrift.MessageType.EXCEPTION, seqid);
...
TCLIServiceProcessor.prototype.process_DownloadData = function(seqid, input, output) {
  var args = new TCLIService_DownloadData_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.DownloadData.length === 1) {
    Q.fcall(this._handler.DownloadData.bind(this._handler),
      args.req
    ).then(function(result) {
      var result_obj = new TCLIService_DownloadData_result({success: result});
      output.writeMessageBegin("DownloadData", Thrift.MessageType.REPLY, seqid);
      result_obj.write(output);
      output.writeMessageEnd();
      output.flush();
    }).catch(function (err) {
      var result;
      result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
      output.writeMessageBegin("DownloadData", Thrift.MessageType.EXCEPTION, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
    });
  } else {
    this._handler.DownloadData(args.req, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new TCLIService_DownloadData_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("DownloadData", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("DownloadData", Thrift.MessageType.EXCEPTION, seqid);
